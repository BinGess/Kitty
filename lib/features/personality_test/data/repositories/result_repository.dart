...
class ResultRepository {
  ...
  static const Map<String, PersonalityType> _jaTypes = {
    'ENFP': PersonalityType(
      code: 'ENFP',
      title: 'ハッピー天使',
      tags: ['#社交的', '#おしゃべり', '#好奇心旺盛'],
      description:
          '生まれつきのムードメーカー。人にも物にも興味津々で、段ボールひとつで長時間楽しめます。注目される場面が大好きで、テンション高めに甘えてきます。',
      advice: '新しい刺激と交流の機会をたくさん用意してあげましょう。興奮して食事を忘れがちなので、給餌リズムは安定させるのがコツです。',
      quote: '「毎日が最高の日だにゃ！」',
    ),
    'ENFJ': PersonalityType(
      code: 'ENFJ',
      title: 'ねこ界の学級委員',
      tags: ['#面倒見がいい', '#リーダー気質', '#やさしい'],
      description:
          '家族全体をよく見ている世話焼きタイプ。あなたが落ち込むと寄り添い、生活リズムの乱れにも敏感です。多頭飼いではまとめ役になることも。',
      advice: '感謝とポジティブな声かけが効果的。家族の活動に参加させると、安心感と満足感が高まります。',
      quote: '「みんな元気なら、それで安心にゃ。」',
    ),
    'ENTP': PersonalityType(
      code: 'ENTP',
      title: 'いたずら発明家',
      tags: ['#頭脳派', '#やんちゃ', '#反骨精神'],
      description: '賢くていたずら好き。引き出しを開けたり物を落としたり、毎日新しい“実験”をしています。退屈がいちばん苦手です。',
      advice: '知育トイや探索課題を多めに。やることが足りないと、自分でミッションを作ってしまいます。',
      quote: '「ルール？破って学ぶにゃ！」',
    ),
    'ENTJ': PersonalityType(
      code: 'ENTJ',
      title: 'ボス猫',
      tags: ['#支配的', '#統率力', '#マイペース'],
      description: '家の主導権を握りたいタイプ。縄張り意識が強く、生活リズムもはっきりしています。視線ひとつで要求が伝わることも。',
      advice: '境界を尊重し、毎日の流れを安定させましょう。突然の変化より、一貫した対応を好みます。',
      quote: '「この家のルールは私が決めるにゃ。」',
    ),
    'ESFP': PersonalityType(
      code: 'ESFP',
      title: 'パーティーキャット',
      tags: ['#目立ちたがり', '#表現豊か', '#陽キャ'],
      description: '人前が大好きなエンターテイナー。転がる、跳ねる、ふざけるが得意で、場を明るくしてくれます。',
      advice: '観客とリアクションが最大のご褒美。短い芸や遊びを繰り返すと、楽しみながら学べます。',
      quote: '「見て見て見てにゃ！」',
    ),
    'ESFJ': PersonalityType(
      code: 'ESFJ',
      title: '甘えんぼサポーター',
      tags: ['#べったり', '#愛情深い', '#安心志向'],
      description: '人との距離が近く、あなたのそばにいると落ち着くタイプ。後追いやふみふみ、ゴロゴロで愛情表現をしてきます。',
      advice: 'スキンシップと声かけを十分に。留守が長い日は、退屈対策や相棒の存在が助けになります。',
      quote: '「今日まだぎゅーしてないにゃ…」',
    ),
    'ESTP': PersonalityType(
      code: 'ESTP',
      title: 'アクションアスリート',
      tags: ['#運動神経抜群', '#大胆', '#体力おばけ'],
      description: 'スピードと高さが大好きな運動派。家中をコースにして駆け回り、瞬発力で遊びを制します。',
      advice: '上下運動できる環境と、追いかけ系の発散遊びを毎日確保。壊れ物は事前に避難を。',
      quote: '「もっと速く、もっと高くにゃ！」',
    ),
    'ESTJ': PersonalityType(
      code: 'ESTJ',
      title: 'ルール管理官',
      tags: ['#規則正しい', '#几帳面', '#時間厳守'],
      description: '生活ルーティンを重視するタイプ。ごはん・寝床・トイレの状態に“基準”があり、乱れると不機嫌になりやすいです。',
      advice: '食事・掃除・遊びの時間をなるべく固定。フードや砂の急な変更は少なめが安心です。',
      quote: '「1分遅れは減点にゃ。」',
    ),
    'INFP': PersonalityType(
      code: 'INFP',
      title: 'もの思い詩人',
      tags: ['#繊細', '#静かな観察者', '#マイワールド'],
      description: '静かな場所でゆっくり過ごすのが好き。外の景色や光の動きを長く眺め、感受性の高さを見せます。',
      advice: '一人で落ち着けるスペースを確保し、無理に社交させないこと。自分のペースを尊重すると安定します。',
      quote: '「あの雲、魚みたいにゃ…」',
    ),
    'INFJ': PersonalityType(
      code: 'INFJ',
      title: 'ミスティック予言家',
      tags: ['#直感型', '#クールに見えて優しい', '#信頼重視'],
      description: '一見クールですが、必要なときにそっと寄り添うタイプ。帰宅時間を読んでいるような行動を見せることもあります。',
      advice: '距離を詰めるより、信頼を積み重ねるのが先。信頼関係ができると、とても深く応えてくれます。',
      quote: '「必要なときは分かるにゃ。」',
    ),
    'INTP': PersonalityType(
      code: 'INTP',
      title: 'ねこ科学者',
      tags: ['#研究者', '#観察好き', '#ひとり時間派'],
      description: '仕組みを理解するのが好きな分析家。水滴や動く物、機械的なおもちゃを長時間観察します。',
      advice: '知的刺激のあるおもちゃや仕掛けを用意すると満足度が上がります。過度な構いすぎは不要です。',
      quote: '「まず原理を調べるにゃ…」',
    ),
    'INTJ': PersonalityType(
      code: 'INTJ',
      title: '影のストラテジスト',
      tags: ['#計画派', '#独立心', '#精密行動'],
      description: '静かに周囲を観察し、狙いを定めて動くタイプ。必要以上にベタベタしませんが、状況把握は非常に正確です。',
      advice: '落ち着いて見渡せる高所と、干渉されない時間を確保すると機嫌よく過ごせます。',
      quote: '「すべて計画どおりにゃ。」',
    ),
    'ISFP': PersonalityType(
      code: 'ISFP',
      title: 'まったりアーティスト',
      tags: ['#自然体', '#癒し系', '#フォトジェニック'],
      description: '居心地のよさを大切にする穏やかなタイプ。日なた、やわらかい寝床、おいしいごはんがあれば幸せです。',
      advice: '快適な環境づくりを最優先に。短時間でもやさしい触れ合いを続けると満足感が高まります。',
      quote: '「のんびりがいちばんにゃ。」',
    ),
    'ISFJ': PersonalityType(
      code: 'ISFJ',
      title: '忠実なガーディアン',
      tags: ['#一途', '#安心重視', '#気配り上手'],
      description: 'いつもあなたの生活圏の近くにいて見守るタイプ。初対面には慎重でも、信頼した相手にはとても忠実です。',
      advice: '環境の安定が最重要。留守時は匂いのついた布を残すと不安軽減に役立ちます。',
      quote: '「あなたのそばが、わたしの家にゃ。」',
    ),
    'ISTP': PersonalityType(
      code: 'ISTP',
      title: 'クールな一匹狼',
      tags: ['#自立型', '#冷静', '#実践派'],
      description: 'べったりしなくても自分のペースでうまく過ごせるタイプ。観察力と反応速度に優れています。',
      advice: '距離感を尊重し、狩猟本能を満たす遊びを取り入れると安定します。',
      quote: '「ひとりでも平気にゃ。」',
    ),
    'ISTJ': PersonalityType(
      code: 'ISTJ',
      title: '堅実なベテラン',
      tags: ['#安定志向', '#まじめ', '#信頼感'],
      description: '規則正しく落ち着いた模範生タイプ。無駄に騒がず、予測可能な毎日を好みます。',
      advice: '生活リズムと環境の安定を維持することが最高のケアです。',
      quote: '「安定こそ正義にゃ。」',
    ),
  };
